  ...
  <div class="bg-black fixed w-[calc(100%+1px)] h-full">
    ...
    <CreatePost 
      :class = "[
        ...
        {'max-h-0 transition-all duration-200 ease-out invisble': !userStore.isMenuOverlay}
      ]"
    />
    <Modal 
      :class = "[
        {'max-h-[100vh] transition-all duration-200 ease-in visible': userStore.isLogoutOverlay },
        {'max-h-0 transition-all duration-200 ease-out invisble': !userStore.isLogoutOverlay}
      ]"
    />
  </div>
</template>
