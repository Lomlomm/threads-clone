<template>
    <div id="MainLayout" class="h-screen text-zinc-50  overflow-auto">
        ...
        <div class="flex w-full max-w-[500px] mx-auto h-screen text-zinc-50">
            <NuxtLayout/>
            <slot></slot>
        </div>
        ...
        >
            <div class="flex w-full max-w-[500px] mx-auto flex items-center justify-around">
                <button 
                    ...
                    class="w-full h-full"
                >
                    <Icon name="material-symbols:home-outline" size="35"/>
                </button>
                <button 
                    @click="userStore.isMenuOverlay = true"
                    class="w-full h-full"
                >
                    <Icon class="mb-1" name="material-symbols:edit-square-outline" size="32"/>
                </button>
                <button 
                    @click="userStore.isLogoutOverlay = true"
                    class="w-full h-full"
                >
                    <Icon class="mb-1" name="ph:sign-out" size="32"/>
                </button>
            </div>
        </div>
    </div>
